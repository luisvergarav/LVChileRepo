...
public class Alternativas  implements java.io.Serializable {
    ...
    public Alternativas(Integer idalternativa, Pregunta pregunta, Integer puntaje, String textoalternativa) {
        this.idalternativa = idalternativa;
        this.pregunta = pregunta;
        this.puntaje = puntaje;
        this.textoalternativa = textoalternativa;
    }
    public Alternativas(Integer idalternativa, Pregunta pregunta, Integer puntaje, Character correcta, String textoalternativa) {
       this.idalternativa = idalternativa;
       this.pregunta = pregunta;
       this.puntaje = puntaje;
