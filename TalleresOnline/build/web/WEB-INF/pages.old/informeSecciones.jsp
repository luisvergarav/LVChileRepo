...
<body>
 ...
 <div class="container" id ="content">
	<h3>
		<c:out value="Secciones de Taller Seleccionado" />
	</h3>
	...
	<th>Nombre Taller</th>
		...
		<c:forEach items="${secciones}" var="seccion">
			<tr>
                                <td ><c:out value="${seccion.taller.nombreTaller}" /></td>
                            
                               <td ><c:out value="${seccion.nombreSeccion}" /></td>
                               
                        	<td><c:out value="${seccion.taller.tipoTaller.nombre}" /></td>
                        ...
                        <td><a href="<c:url value="/informes/informeAlumnoSeccion.do?codSeccion=${seccion.codSeccion}" />">Alumnos</a></td>        
