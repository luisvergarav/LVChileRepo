...
<body>
 ...
 <div class="container" id="content"> 
	...
	<p>
		<a href="<c:url value="/inscripciones/coordinacion/listadoInscripcionesAlumno.do" />">volver</a>
	</p>
	...
	<table id="tabla1" cellpadding='3' cellspacing='2' class="table table-filter  tableWrap table-striped">
		...
		<c:forEach items="${listaTalleresDisponibles}" var="taller">
			...
			<c:if test="${taller.claseTaller == 'CO'}">
				...
				href="<c:url value="/inscripciones/coordinacion/guardarInscripcionCoordinacion.do?idTaller=${taller.idTaller}" />" ><img width="30" height="30" src="<%= request.getContextPath() %>/resources/img/seleccionar.jpg"/></a></td>
                        <td>
