...
<body>
 ...
 <div class="container" id="contento">
	...
	<tr>
            <td> <label>Nombre Seccion : </label></td>
            <td> <label>${seccion.codSeccion} ${seccion.nombreSeccion}</label></td>	
            
            <td> <label>Cupos : ${seccion.cupos}</label></td>
        ...
        <div class="tableWrap">
            <form:form commandName="diaSeccion" action="agregarDiaSeccion.do" method="post">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><form:input path="diaTaller" /></td>
    ...
    <tfoot>    
        <tr>
            <td><button name='boton' type='submit' id="btnAgregarDia" class="btn btn-primary">Agregar</button></td>
        </tr>
    </tfoot>    
</table>  
