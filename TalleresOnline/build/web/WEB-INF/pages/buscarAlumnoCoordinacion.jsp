...
<div class="container" id="content">
    <h3>Busqueda Alumnos - Inscribir / Dar de baja</h3>
	<div class="tableWrap">
	<form method='post' action='<%=request.getContextPath()%>/inscripciones/coordinacion/buscarAlumnoCoordinacion.do'>
	...
	<table id="tabla1" cellpadding='3' cellspacing='2' class="table table-filter tableWrap table-striped">
		...
		<c:forEach items="${alumnos}" var="alumno">
			...
			<td>
                        ...
                        <td><a href="<c:url value="/inscripciones/coordinacion/listadoInscripcionesAlumno.do?rutAlumno=${alumno.rutAlumno}" />" >Ver</a></td>
